...
export default function SavedRecipeCard({ recipe, index, onOpen, onDelete }: Props) {
		...
		>
			...
			>
				...
				<button
					...
					className="cursor-pointer absolute right-[11px] top-[11px] flex h-[34px] w-[34px] items-center justify-center rounded-full bg-surface/90 text-muted shadow-[0_2px_8px_rgba(46,42,37,0.14)] transition-colors hover:bg-terracotta hover:text-white"
				>
					<Trash size={16} />
				</button>
			</div>

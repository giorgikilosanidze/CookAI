...
export default function CtaBanner() {
	return (
		<section className="mx-auto w-full max-w-280 px-6 py-18">
			<div className="flex flex-col items-center gap-4.5 rounded-3xl bg-terracotta px-10 py-14 text-center shadow-[0_16px_40px_rgba(198,93,59,0.28)]">
				...
				<p className="max-w-[46ch] text-[17px] leading-normal text-cream/90">
					It&rsquo;s free to try — no account needed to generate your first recipe.
				</p>
				<Link
					href="/generate"
